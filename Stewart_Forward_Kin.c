 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Mar 18 13:51:46 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Stewart_Forward_Kin
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 actual_lengths
#define INPUT_0_DIMS_ND                {6,1}
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 platform_parameters
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                actual_pos
...
extern void Stewart_Forward_Kin_Outputs_wrapper(const real_T *actual_lengths,
  const real_T *platform_parameters,
  real_T *actual_pos,
  const real_T *xD);
extern void Stewart_Forward_Kin_Update_wrapper(const real_T *actual_lengths,
  const real_T *platform_parameters,
  real_T *actual_pos,
  real_T *xD);
...
{
  const real_T *actual_lengths = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *platform_parameters = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *actual_pos = (real_T *) ssGetOutputPortRealSignal(S, 0);
  const real_T *xD = ssGetDiscStates(S);
  Stewart_Forward_Kin_Outputs_wrapper(actual_lengths, platform_parameters,
    actual_pos, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  Stewart_Forward_Kin_Update_wrapper(actual_lengths, platform_parameters,
    actual_pos, xD);
}
